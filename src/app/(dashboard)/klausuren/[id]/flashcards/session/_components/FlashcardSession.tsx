      ...
      <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 py-4 md:px-8 md:py-6">
        <div className="w-full max-w-md text-center">
          ...
          <h2 className="mb-2 text-xl font-semibold tracking-tight text-foreground">
            {total === 0 ? "Keine Karteikarten" : "Session abgeschlossen"}
          </h2>
          {total === 0 ? (
            <p className="mb-8 text-sm text-muted-foreground">
              Für diese Auswahl gibt es keine Karteikarten.
            </p>
          ) : (
            <div className="mb-8">
          ...
          <Link href={`/klausuren/${examId}/flashcards`} className={buttonVariants()}>
    ...
    <div className="px-4 py-4 md:px-8 md:py-6">
      <div className="max-w-[960px]">
        <div className="mb-6 flex items-center justify-between">
          <Link
            href={`/klausuren/${examId}/flashcards`}
